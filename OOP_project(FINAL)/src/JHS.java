...
class JHS extends Student {
    String spec;
    
    //constructor
    public JHS (String LRN, String name, 
            ...
            String graduationDate1, String school2, String accomplishments2, String dateOfAttendance2, 
            String graduationDate2, int gradeLevel, String specialization) {
        this.name = name;   
        this.LRN = LRN;
    ...
    public void savestudent() {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("JHSstudents.txt", true))) {
            ...
            writer.write("Specialization: " + this.spec);
    ...
    public void clearFile() {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("JHSstudents.txt", false))) {
            writer.write("");
        } catch (IOException e) {
            e.printStackTrace();
        }
